...
class User implements UserInterface
{
     ...
     * @Groups({"User_read", "Post_read", "Comment_read"})
     */
    private $id;
     ...
     * @Assert\NotBlank(message="Veuillez renseignez un password")
     */
    private $password;
     ...
     * @Groups({"User_read", "Post_read", "Comment_read"})
     * @Assert\NotBlank(message="Veuillez renseignez un nom ou pseudo")
     */
    private $name;
